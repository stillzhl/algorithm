 ...
 * PC C libraries but missing from many UNIC C libraries.
 *-------------------------------------------------------------*/
...
int main(int argc, char *argv[])
{
    ...
    L1 = CreateLList(CreateData1, DeleteData1,
                    DuplicateData1, NodeDataCmp1);

    long_wd = CreateLList(CreateData2, DeleteData2,
                    DuplicateData2, NodeDataCmp2);
    ...
    else                    /* step thru the list and print it */
    {
        Link pcurr;

        for (pcurr = long_wd->LHead; pcurr != NULL;
